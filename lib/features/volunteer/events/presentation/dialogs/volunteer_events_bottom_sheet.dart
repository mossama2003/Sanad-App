...
class VolunteerEventsBottomSheet extends StatelessWidget {
  const VolunteerEventsBottomSheet({
    super.key,
    required this.event,
    this.onJoinTap,
  });
      ...
      child: Column(
        children: [
          _EventDetailItem(
            ...
            value: DateFormat('dd MMM yyyy - hh:mm a').format(event.date),
            textColor: textColor,
            secondaryColor: secondaryColor,
          ),
          ...
          _EventDetailItem(
            ...
            value: 'volunteer.events.bottom_sheet.members'.tr(
              namedArgs: {
                'joined': event.joiners.toString(),
                'needed': event.spots.toString(),
                'spots': (event.spots - event.joiners).toString(),
              },
            ),
            textColor: textColor,
            secondaryColor: secondaryColor,
