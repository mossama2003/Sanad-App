...
part of 'volunteer_event_details_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class VolunteerEventDetailsModelAdapter
    extends TypeAdapter<VolunteerEventDetailsModel> {
  @override
  final int typeId = 2;

  @override
  VolunteerEventDetailsModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, VolunteerEventDetailsModel obj) {
    writer
      ..writeByte(21)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is VolunteerEventDetailsModelAdapter &&
