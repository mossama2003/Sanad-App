...
class VolunteerMyEventsSection extends StatelessWidget {
  const VolunteerMyEventsSection({super.key, required this.events});
  ...
  Widget build(BuildContext context) {
    ...
    final homeCubit = VolunteerHomeCubit.get(context);

    return BlocBuilder<VolunteerEventsCubit, VolunteerEventsState>(
      builder: (context, state) {
        final cubit = VolunteerEventsCubit.get(context);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    homeCubit.updateSelectedNavbarItem(
