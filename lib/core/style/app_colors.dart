...
class AppColors {
  ...
  static const Color scaffoldBgDark = Color(0xffFFFFFF);
  ...
  static const Color appbarTextDark = Color(0xff020617);
  static const Color appbarTextLight = Color(0xff851D41);

  static Color get appbarText => isDark ? appbarTextDark : appbarTextLight;

  static const Color appbarBgDark = Color(0xffFFFFFF);
  static const Color appbarBgLight = Color(0xffFFFFFF);

  static Color get appbarBg => isDark ? appbarTextDark : appbarTextLight;

  static const Color navbarSelectedDark = Color(0xff020617);
  static const Color navbarUnSelectedDark = Color(0xff020617);

  static Color get navbarSelected =>
      isDark ? navbarSelectedDark : navbarSelectedLight;

  static const Color navbarSelectedLight = Color(0xff94A3B8);
  static const Color navbarUnSelectedLight = Color(0xff98A2B3);

  static Color get navbarUnSelected =>
      isDark ? navbarUnSelectedDark : navbarSelectedLight;

  static const Color navbarBgDark = Color(0xffFFFFFF);
